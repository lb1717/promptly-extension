...
const FALLBACK_RELEASE_TAG = "companion-v0.1.13";
...
const FALLBACK_ASSETS: CompanionAssetUrls = {
  version: "0.1.13",
  macDmg: `${FALLBACK_BASE}/Promptly-Companion-0.1.13-mac.dmg`,
  macZip: `${FALLBACK_BASE}/Promptly-Companion-0.1.13-mac.zip`,
  winExe: `${FALLBACK_BASE}/Promptly-Companion-0.1.13-win.exe`
};
