...
const FALLBACK_RELEASE_TAG = "companion-v0.1.11";
...
const FALLBACK_ASSETS: CompanionAssetUrls = {
  version: "0.1.11",
  macDmg: `${FALLBACK_BASE}/Promptly-Companion-0.1.11-mac.dmg`,
  macZip: `${FALLBACK_BASE}/Promptly-Companion-0.1.11-mac.zip`,
  winExe: `${FALLBACK_BASE}/Promptly-Companion-0.1.11-win.exe`
};
