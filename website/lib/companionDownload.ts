...
const FALLBACK_RELEASE_TAG = "companion-v0.1.14";
...
const FALLBACK_ASSETS: CompanionAssetUrls = {
  version: "0.1.14",
  macDmg: `${FALLBACK_BASE}/Promptly-Companion-0.1.14-mac.dmg`,
  macZip: `${FALLBACK_BASE}/Promptly-Companion-0.1.14-mac.zip`,
  winExe: `${FALLBACK_BASE}/Promptly-Companion-0.1.14-win.exe`
};
