...
const FALLBACK_RELEASE_TAG = "companion-v0.1.12";
...
const FALLBACK_ASSETS: CompanionAssetUrls = {
  version: "0.1.12",
  macDmg: `${FALLBACK_BASE}/Promptly-Companion-0.1.12-mac.dmg`,
  macZip: `${FALLBACK_BASE}/Promptly-Companion-0.1.12-mac.zip`,
  winExe: `${FALLBACK_BASE}/Promptly-Companion-0.1.12-win.exe`
};
