...
const FALLBACK_RELEASE_TAG = "companion-v0.1.4";
...
const FALLBACK_ASSETS: CompanionAssetUrls = {
  version: "0.1.4",
  macDmg: `${FALLBACK_BASE}/Promptly-Companion-0.1.4-mac.dmg`,
  macZip: `${FALLBACK_BASE}/Promptly-Companion-0.1.4-mac.zip`,
  winExe: `${FALLBACK_BASE}/Promptly-Companion-0.1.4-win.exe`
};
